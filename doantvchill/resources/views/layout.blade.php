...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
            ...
            <div class="row" id="headwrap">
               <div class="col-md-3 col-sm-6 slogan">
                  <p class=""><a class="logo" href="" title="phim hay ">
                     <img src="{{asset('uploads/logo/'.$info->logo)}}" alt="" style="margin-top:20px">
                  </a>
                  </p>
                          ...
                          <style type="text/css">
                           ...
                           <div class="form-group form-timkiem">
                              <div class="input-group col-xs-12">
                                 <form action="{{route('tim-kiem')}}" method="GET" style="width:150%">
                                 <input style=" width: 70%; margin-top: 20px" id="timkiem" type="text" name="search" class="form-control" placeholder="Tìm kiếm..." autocomplete="off" required>
                                <button style="width: 20%;margin-top: 22px; margin-left: 20px;color:white" class="btn btn-primary" >Tìm kiếm</button>
                              </form>
                              </div>
                           </div>
            ...
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  <div class="footer-logo">
                     <img class="img-responsive" src="{{asset('uploads/logo/'.$info->logo)}}" alt="2023- Xem phim hay nhất" />
                  </div>
      ...
      <div style=" text-align: center">
          <p>Copyright @ 2023 By HaNgocHung</p>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="MOCYked7"></script>
...
{{-- hiển thị phim hot --}}
      <script type="text/javascript">
         ...
         owl.owlCarousel({loop: true,margin: 4,autoplay: true,autoplayTimeout: 4000,autoplayHoverPause: true,nav: true,navText: [' <i class="fa fa-arrow-left" aria-hidden="true"></i>'
         , '<i class="fa fa-arrow-right" aria-hidden="true"></i>'],responsiveClass: true,responsive: {0: {items:2},480: {items:3}, 600: {items:4},1000: {items: 5}}})});
      </script>
{{-- Chỉnh topview trang chủ --}}
      <script type="text/javascript">
            ...
            if(search!=''){
               ...
               $.getJSON('/json/movies.json', function(data){
                  $.each(data, function(key, value){
                     ...
                     {
                        // $('#result').css('display', 'inherit');
                        // $('#result').append('<li style=style="cursor:pointer; display: flex; max-height: 200px;" class="list-group-item link-class"><img src="/uploads/movie/'+value.image+
                        //    '"height="40" width="100" class="" />'+value.title+' -> <span class="text-muted" style="display: -webkit-box; max-height: 8.2rem; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; white-space: normal; -webkit-line-clamp: 5; line-height: 1.6rem;" >'+value.description+'</span></li>');
                        $('#result').append('<li style="cursor:pointer" class="list-group-item link-class"><img src="/uploads/movie/'+value.image+
                           '"height="40" width="40" class="" />'+value.title+' .<br> <span class="text-muted">'+value.description+'</span></li>');
